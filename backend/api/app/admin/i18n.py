...
TRANSLATIONS: dict[str, dict[Lang, str]] = {
    ...
    "lens.json_hint":       {"es": "Estructura: {\"version\":\"x.y.z\", \"catalogo\":[{\"id\":\"...\", \"tipo\":\"...\", \"params\":{...}}, ...]}",
                             "en": "Structure: {\"version\":\"x.y.z\", \"catalogo\":[{\"id\":\"...\", \"tipo\":\"...\", \"params\":{...}}, ...]}"},
    ...
    "lens.param.halo":      {"es": "Halos",                           "en": "Halos"},
    "lens.param.contrast":  {"es": "Perdida contraste",               "en": "Contrast loss"},
    "lens.param.blur_near": {"es": "Blur cerca",                      "en": "Near blur"},
    "lens.param.blur_med":  {"es": "Blur medio",                      "en": "Medium blur"},
    "lens.param.blur_far":  {"es": "Blur lejos",                      "en": "Far blur"},
    "lens.param.focal":     {"es": "Distancia focal (m)",             "en": "Focal distance (m)"},
